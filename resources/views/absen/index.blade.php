            ...
            <div class="card">
                <div class="card-body text-center p-2">
                    <div class="list-menu">
                        ...
                        @if(Str::contains(strtolower($pegawai->jabat->jabatan), ['supervisor', 'kepala', 'koordinator']) )
                    ...
                    @if(Str::contains(strtolower($pegawai->jabat->jabatan), ['danru', 'komandan regu', 'supervisor', 'trc']) == true && Str::contains(strtolower($pegawai->sat->satuan_kerja), ['kamdal', 'pam', 'pengamanan', 'satpam']) == true)
                         ...
                         <div class="item-menu text-center" onclick="popupPengamanan()" style="cursor:pointer;">
                            <div class="menu-icon">
                                <!-- <ion-icon name="shield" style="font-size:40px;"></ion-icon> -->
                                <img src="{{asset('storage/img/pam.png')}}" width="40px">
                            </div>
                            <div class="menu-name">
                                <span class="text-center">PAM</span>
                            </div>
                        </div>

                        <script>
function popupPengamanan() {
    Swal.fire({
        html: `
            <div style="display:flex; justify-content:space-around; margin-top:20px;">
                ...
                <div class="item-menu text-center">
                    <div class="menu-icon">
                        <a href="{{ route('absen.lapor') }}" style="font-size:40px; color:#0d6efd;">
                            <ion-icon name="document-text"></ion-icon>
                        </a>
                    </div>
                    <div class="menu-name">
                ...
                <div class="item-menu text-center">
                    <div class="menu-icon">
                        <a href="{{ route('absen.patroli') }}" style="font-size:40px; color:green;">
                            <ion-icon name="shield-checkmark"></ion-icon>
                        </a>
                    </div>
                    <div class="menu-name">
                ...
                <div class="item-menu text-center">
                    <div class="menu-icon">
                        <a href="{{route('tukar-jaga.index')}}" style="font-size:40px; color:orange;">
                            <ion-icon name="swap-horizontal"></ion-icon>
                        </a>
                    </div>
                    <div class="menu-name">
                        <span>Serah<br/>Terima</span>
                    </div>
                </div>
