...
<div style="margin-top: 3.5rem;" class="bg-light">
    ...
    <div class="container py-3" style="margin-bottom: 3rem;">
                ...
                <div class="list-group">
                    ...
                    <div id="nowaField" class="list-group-item border-0 px-0 d-flex align-items-center justify-content-between" style="gap: 1rem;">
                        ...
                        @if($profile->shift == null)
                            <div>
                                <small>Shift</small>
                                <p id="nowa" class="mb-0 fw-bold">Optional
                                </p>
                            </div>
                        @else
                            <div>
        ...
        <div class="card shadow-sm rounded-4 mb-2 border-0">
            ...
            <div id="vermuk" class="card shadow-sm rounded-4 mb-2 border-0">
                <div class="card-body p-3 text-center">
                    @if($profile->face_embedding == null)
                    <button id="btnRegisterFace" class="btn btn-danger w-100 rounded-pill">
                    ...
                    <input type="hidden" id="pegawai_id" value="{{ Auth::guard('pegawai')->user()->id }}">
                    @else
                    <small class="text-muted d-block mt-1">
