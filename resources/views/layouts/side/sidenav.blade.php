...
<a onclick="cekMaster()" class="list-group-item list-group-item-action bg-light {{ Route::is('tenant')||Route::is('kantor')||Route::is('satker')|| Route::is('satker')? 'active' : '' }}" data-bs-toggle="collapse"  href="#master" role="button" aria-expanded="false" aria-controls="master">
            Master Data
                    <i id="mas" class="bi bi-caret-right-fill"></i>
          </a>
            <div class="collapse {{ Route::is('tenant')||Route::is('kantor')||Route::is('satker')|| Route::is('satker')? 'show' : '' }}" id="master">
