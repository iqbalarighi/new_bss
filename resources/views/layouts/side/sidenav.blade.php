...
@if(Auth::user()->role == 0 || Auth::user()->role == 1 || Auth::user()->role == 3)
        <?php $masterActive = request()->is('tenant') || request()->is('users') || request()->is('checkpoints') || request()->is('kantor') || request()->is('satker') || request()->is('jabatan') || request()->is('shift') || request()->is('departemen'); ?>
