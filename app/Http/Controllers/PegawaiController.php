            ...
            ->when($request->filled('keyword'), function ($query) use ($request) {
                ...
                $query->where(function ($q) use ($keyword) {
                    $q->where('nip', 'like', "%{$keyword}%")
                      ...
                      ->orWhereHas('deptmn', function ($dep) use ($keyword) {
                          $dep->where('nama_dept', 'like', "%{$keyword}%");
                      })

                      ->orWhereHas('sat', function ($sat) use ($keyword) {
                          $sat->where('nama_satker', 'like', "%{$keyword}%");
                      })

                      ->orWhereHas('jabat', function ($jabat) use ($keyword) {
                          $jabat->where('nama_jabatan', 'like', "%{$keyword}%");
                      })

                      ->orWhereHas('kantor', function ($kantor) use ($keyword) {
                          $kantor->where('nama_kantor', 'like', "%{$keyword}%");
                      });
                });
            })
            ->paginate(15)
            ...
            ->when($request->filled('keyword'), function ($query) use ($request) {
                ...
                $query->where(function ($q) use ($keyword) {
                    $q->where('nip', 'like', "%{$keyword}%")
                      ...
                      ->orWhereHas('sat', function ($sat) use ($keyword) {
                          $sat->where('satuan_kerja', 'like', "%{$keyword}%");
                      })

                      ->orWhereHas('jabat', function ($jabat) use ($keyword) {
                          $jabat->where('jabatan', 'like', "%{$keyword}%");
                      })
